var Znote = React.createClass({
    ...
    , randomBetween: function(p_min, p_max) {
		...
		, save: function(){
				this.props.onChange(this.refs.znewText.getDOMNode().value
														, this.props.index);
        ...
        return (
            <div className="znote" style={this.style}>
		...
		, renderForm: function(){
				return (
						<div className="znote" style={this.style}>
							<textarea ref="znewText" defaultValue={this.props.children} 
...
React.render(<Zboard count={12} />
							, document.getElementById('zreact-container'));