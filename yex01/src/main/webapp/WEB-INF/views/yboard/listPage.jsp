						...
						<c:forEach items="${list}" var="boardVO">
							...
							<tr>
								...
								...http://localhost:8080/z/zboard/listPage?page=19&perPageNum=10로 호출가능.
								 -->
								<td><a href='/y/yboard/readPage${pageMaker.makeQuery(pageMaker.cri.page)}&bno=${boardVO.bno}'>
										${boardVO.title}
									</a>
								</td>
						...
						<ul class="pagination">
							...
							<c:if test="${pageMaker.prev}">
								...
								<!-- 
								 ...
								 -->
									<a href="/y/yboard/listPage${pageMaker.makeQuery(pageMaker.startPage - 1)}">&laquo;</a>
							...
							<c:forEach begin="${pageMaker.startPage }"
								...
								<!-- 
								 ...
								 -->
									<a href="/y/yboard/listPage${pageMaker.makeQuery(idx)}">${idx}</a>
								</li>
							</c:forEach>
							...
							<c:if test="${pageMaker.next && pageMaker.endPage > 0}">
								...
								<!-- 
									...276p.↓.
									<a href="/z/zboard/listPage?page=250">&raquo;</a>
									<a href="/z/zboard/listPage?page=${pageMaker.endPage + 1}">&raquo;</a>
								 ...
								 -->								
									<a href="/y/yboard/listPage${pageMaker.makeQuery(pageMaker.endPage + 1)}">&raquo;</a>
