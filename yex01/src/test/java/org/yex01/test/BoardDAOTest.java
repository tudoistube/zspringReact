...
public class BoardDAOTest {
	...
	public void testURI() throws Exception {
		...
		UriComponents uriComponents = UriComponentsBuilder.newInstance().path("/yboard/read").queryParam("bno", 12)
				.queryParam("perPageNum", 20).build();

		logger.info("/yboard/read?bno=12&perPageNum=20");
