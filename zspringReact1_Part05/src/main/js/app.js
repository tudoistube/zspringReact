...
/*
 * ...S.added since Part05.
 *    The manager field isn’t something you want people to edit directly. 
 *    Since it’s inlined, it should be viewed as a read only attribute. 
 *    To filter it out inlined entries from the CreateDialog and  UpdateDialog, 
...
//...S.added since Part05.
//   With security checks configured on the backend, add a handler in case someone tries 
//   to update a record without authorization:
 ...
 ...after : */
	onNavigate(navUri) {
		client({
			...
			//XXX.this.page = employeeCollection.entity.page; //XXX.since Part05.XXX.
	...
	render() {
		return (
			<tr>
				...
				<td>{this.props.employee.entity.manager.name}</td>{/*...added since Part 5. */}
				<td>
