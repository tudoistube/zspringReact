...
import org.yex01.service.IF_ReplyService;
...
public class ReplyController {
	 ...
	 * ...http://localhost:8080/y2/replies/all/1638456
			Content-Type: application/json	
	 */
	 ...
	 * 
	 * ...아래 URI에서 11은 댓글번호임.
	 * ...http://localhost:8080/y2/replies/11
			Content-Type: application/json
			{
			 "replytext" : "z2댓글을 수정"
			 }
	 ...
	 * ...388p.
	 * ...아래 URI에서 11은 댓글번호임. 
	 * ...http://localhost:8080/y2/replies/4
			Content-Type: application/json
	 */
