...
<body>
	...
	<!-- 
		...412p.
		...수정과 삭제작업을 하는 div.
		...평상시에는 안보xd이도록 하고, 각 댓글 항목의 'MOD'버튼을 누르는 경우에만
		...보이도록 함.
	 -->
	...
	-->
	<script src="/y2/resources/plugins/jQuery/jquery-2.2.0.js"></script>
	...
	<script>
		...
		*/		
		...
		//selectReplies();//...398p.댓글페이지 표기이후 주석처리함.
						...
						$(data).each(
									function() {
											str += "<li data-rno='"+this.rno+"' class='replyLi'>"
													...
													+ this.replytext;
/*
 * ...409p.댓글수정시 순수한 댓글 내용만 나오도록 주석처리함.
      http://cafe.naver.com/gugucoding/1057
 ...
 * ...409p.댓글수정시 순수한 댓글 내용만 나오도록 주석처리함.
      http://cafe.naver.com/gugucoding/1057	 	
		...
		$("#replies").on("click", ".replyLi", function() {			
 ...
 * ...409p.댓글수정시 순수한 댓글 내용만 나오도록 주석처리함.
      http://cafe.naver.com/gugucoding/1057
		...
		function selectPageReplies(page){
			  ...
			  $.getJSON("/y2/replies/"+bno+"/"+page , function(data){
